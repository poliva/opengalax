...
**Why?** Because EETI only offers closed source drivers for those touch panels, the eGalax Touch driver is outdated and
doesn't work properly on newer Xorg servers (the module ABI differs), and the newer closed source eGTouch daemon driver
